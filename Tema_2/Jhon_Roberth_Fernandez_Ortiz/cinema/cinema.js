...
function suggest(reserva) {
    ...
    return getConsecutiveChairs(availableChairs.map(x => x.id), reserva);
}

function getConsecutiveChairs(arr, count) {
...
console.log(suggest(5)); // [true, true, true, true, true, true, true, true, true, true]
